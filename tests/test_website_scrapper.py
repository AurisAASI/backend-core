...
def mock_gemini_handler():
    ...
    with patch('src.models.scrappers.website_scrapper.GoogleGeminiHandler') as mock_class:
        mock_instance = MagicMock()
        mock_class.return_value = mock_instance
        yield mock_instance
...
class TestWebsiteScrapperInit:
    ...
    def test_init_normalizes_url_without_scheme(self, mock_settings, mock_db_handler, mock_gemini_handler):
    ...
    def test_init_invalid_url_raises_error(self, mock_settings, mock_db_handler, mock_gemini_handler):
    ...
    def test_init_gemini_handler_failure(self, mock_settings, mock_db_handler):
        ...
        with patch('src.models.scrappers.website_scrapper.GoogleGeminiHandler', side_effect=Exception('API key invalid')):
...
class TestURLNormalization:
    ...
    def test_normalize_url_adds_https(self, mock_settings, mock_db_handler, mock_gemini_handler):
    ...
    def test_normalize_url_preserves_http(self, mock_settings, mock_db_handler, mock_gemini_handler):
    ...
    def test_normalize_url_strips_whitespace(self, mock_settings, mock_db_handler, mock_gemini_handler):
...
class TestRobotsTxtCheck:
    ...
    def test_check_robots_txt_allowed(self, mock_robot_parser_class, mock_settings, mock_db_handler, mock_gemini_handler):
    ...
    @patch('src.models.scrappers.website_scrapper.RobotFileParser')
    def test_check_robots_txt_disallowed(self, mock_robot_parser_class, mock_settings, mock_db_handler, mock_gemini_handler):
    ...
    @patch('src.models.scrappers.website_scrapper.RobotFileParser')
    def test_check_robots_txt_not_found_allows(self, mock_robot_parser_class, mock_settings, mock_db_handler, mock_gemini_handler):
...
class TestPageDiscovery:
    ...
    def test_discover_pages_from_sitemap(self, mock_get, mock_settings, mock_db_handler, mock_gemini_handler, sample_sitemap_xml):
        ...
        assert 'https://audicare.com.br/' in pages or 'https://audicare.com.br/sobre' in pages

    @patch('src.models.scrappers.website_scrapper.requests.get')
    def test_discover_pages_from_homepage(self, mock_get, mock_settings, mock_db_handler, mock_gemini_handler, sample_html_homepage):
    ...
    def test_discover_pages_common_paths(self, mock_settings, mock_db_handler, mock_gemini_handler):
...
class TestHTMLFetching:
    ...
    @patch('src.models.scrappers.website_scrapper.requests.get')
    def test_fetch_page_content_success(self, mock_get, mock_settings, mock_db_handler, mock_gemini_handler, sample_html_homepage):
    ...
    @patch('src.models.scrappers.website_scrapper.requests.get')
    def test_fetch_page_content_404(self, mock_get, mock_settings, mock_db_handler, mock_gemini_handler):
    ...
    @patch('src.models.scrappers.website_scrapper.requests.get')
    def test_fetch_page_content_timeout(self, mock_get, mock_settings, mock_db_handler, mock_gemini_handler):
...
class TestTextExtraction:
    ...
    def test_extract_text_from_html(self, mock_settings, mock_db_handler, mock_gemini_handler, sample_html_about):
    ...
    def test_extract_text_removes_scripts(self, mock_settings, mock_db_handler, mock_gemini_handler):
...
class TestStructuredDataExtraction:
    ...
    @patch('builtins.open', new_callable=mock_open, read_data='{"type": "object", "properties": {}}')
    def test_extract_structured_data_success(self, mock_file, mock_settings, mock_db_handler, mock_gemini_handler, sample_html_about, sample_gemini_response):
        ...
        mock_gemini_handler.generate_content.return_value = json.dumps(sample_gemini_response)

        pages_content = {
            'https://audicare.com.br/sobre': sample_html_about
        }
    ...
    @patch('builtins.open', new_callable=mock_open, read_data='{"type": "object", "properties": {}}')
    def test_extract_structured_data_no_content(self, mock_file, mock_settings, mock_db_handler, mock_gemini_handler):
    ...
    def test_extract_structured_data_schema_not_found(self, mock_file, mock_settings, mock_db_handler, mock_gemini_handler, sample_html_about):
...
class TestDatabaseOperations:
    ...
    def test_save_to_database_success(self, mock_settings, mock_db_handler, mock_gemini_handler, sample_gemini_response):
    ...
    def test_save_to_database_no_handler(self, mock_settings, mock_gemini_handler):
        ...
        with patch('src.models.scrappers.website_scrapper.DatabaseHandler', side_effect=Exception('DB error')):
            scrapper = WebsiteScrapper(
                company_id='test-uuid-123',
                website='https://audicare.com.br',
                gemini_api_key='test-key'
    ...
    def test_save_to_database_update_error(self, mock_settings, mock_db_handler, mock_gemini_handler):
...
class TestCollectDataWorkflow:
    ...
    @patch('src.models.scrappers.website_scrapper.requests.get')
    @patch('builtins.open', new_callable=mock_open, read_data='{"type": "object", "properties": {}}')
    def test_collect_data_full_workflow(self, mock_file, mock_get, mock_sleep, mock_settings, mock_db_handler, mock_gemini_handler, sample_html_homepage, sample_html_about, sample_gemini_response):
    ...
    @patch('src.models.scrappers.website_scrapper.RobotFileParser')
    def test_collect_data_robots_txt_disallowed(self, mock_robot_parser_class, mock_settings, mock_db_handler, mock_gemini_handler):
    ...
    def test_collect_data_invalid_url(self, mock_settings, mock_db_handler, mock_gemini_handler):
    ...
    @patch('src.models.scrappers.website_scrapper.time.sleep')
    @patch('src.models.scrappers.website_scrapper.requests.get')
    def test_collect_data_no_pages_fetched(self, mock_get, mock_sleep, mock_settings, mock_db_handler, mock_gemini_handler):
